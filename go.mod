...
// workaround for https://github.com/docker/compose/issues/12747. Can be remove when testcontainer upgrades its
// docker-compose version. Only causes issues since we run our test with the race detector enabled.
replace github.com/docker/compose/v2 v2.35.0 => github.com/docker/compose/v2 v2.38.2
