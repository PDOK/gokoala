...
export function getCollections$Html(http: HttpClient, rootUrl: string, params?: GetCollections$Html$Params, context?: HttpContext): Observable<StrictHttpResponse<string>> {
