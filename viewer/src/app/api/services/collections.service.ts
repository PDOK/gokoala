...
import { GetCollections$Html$Params, getCollections$Html } from '../fn/collections/get-collections-html'
import { GetCollections$Json$Params, getCollections$Json } from '../fn/collections/get-collections-json'
...
export class CollectionsService extends BaseService {
  ...
  getCollections$Json(params?: GetCollections$Json$Params, context?: HttpContext): Observable<Collections> {
    return this.getCollections$Json$Response(params, context).pipe(map((r: StrictHttpResponse<Collections>): Collections => r.body))
  }
  ...
  getCollections$Html(params?: GetCollections$Html$Params, context?: HttpContext): Observable<string> {
    return this.getCollections$Html$Response(params, context).pipe(map((r: StrictHttpResponse<string>): string => r.body))
  }
}
