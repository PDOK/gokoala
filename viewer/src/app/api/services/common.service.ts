...
export class CommonService extends BaseService {
  ...
  getLandingPage$Json(params?: GetLandingPage$Json$Params, context?: HttpContext): Observable<LandingPage> {
    return this.getLandingPage$Json$Response(params, context).pipe(
   ...
   * This method doesn't expect any request body.
   */
  getLandingPage$JsonVersion30$Response(params?: GetLandingPage$JsonVersion30$Params, context?: HttpContext): Observable<StrictHttpResponse<LandingPage>> {
  ...
  getLandingPage$Html(params?: GetLandingPage$Html$Params, context?: HttpContext): Observable<string> {
    return this.getLandingPage$Html$Response(params, context).pipe(
  ...
  getOpenApi(params?: GetOpenApi$Params, context?: HttpContext): Observable<void> {
    return this.getOpenApi$Response(params, context).pipe(
   ...
   * This method doesn't expect any request body.
   */
  getConformanceDeclaration$Json$Response(params?: GetConformanceDeclaration$Json$Params, context?: HttpContext): Observable<StrictHttpResponse<ConfClasses>> {
   ...
   * This method doesn't expect any request body.
   */
  getConformanceDeclaration$Html$Response(params?: GetConformanceDeclaration$Html$Params, context?: HttpContext): Observable<StrictHttpResponse<string>> {
  ...
  getConformanceDeclaration$Html(params?: GetConformanceDeclaration$Html$Params, context?: HttpContext): Observable<string> {
    return this.getConformanceDeclaration$Html$Response(params, context).pipe(
      map((r: StrictHttpResponse<string>): string => r.body)
    );
  }
