...
## OGC API Features with "attribute data" example - experimental feature
...
This feature can be enabled using the feature flag `supportsNonGeoData: true`.

Note: `supportsNonGeoData` is an experimental feature and can be changed in the future. 
