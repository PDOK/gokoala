...
func (in *OgcAPI3dGeoVolumes) DeepCopyInto(out *OgcAPI3dGeoVolumes) {
	*out = *in
	...
	if in.Collections != nil {
		...
		*out = make([]CollectionEntry3dGeoVolumes, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *OgcAPIFeatures) DeepCopyInto(out *OgcAPIFeatures) {
	*out = *in
	if in.Collections != nil {
		in, out := &in.Collections, &out.Collections
		*out = make([]CollectionEntryFeatures, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *OgcAPIFeaturesSearch) DeepCopyInto(out *OgcAPIFeaturesSearch) {
	*out = *in
	...
	if in.Collections != nil {
		in, out := &in.Collections, &out.Collections
		*out = make([]CollectionEntryFeaturesSearch, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *OgcAPITiles) DeepCopyInto(out *OgcAPITiles) {
	*out = *in
	...
	if in.Collections != nil {
		in, out := &in.Collections, &out.Collections
		*out = make([]CollectionEntryTiles, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
