...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new InitDownload.
func (in *InitDownload) DeepCopy() *InitDownload {
	if in == nil {
		return nil
	}
	out := new(InitDownload)
