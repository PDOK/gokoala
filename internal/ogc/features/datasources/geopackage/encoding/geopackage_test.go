// Package encoding based on https://github.com/go-spatial/geom/blob/master/encoding/gpkg/binary_header_internal_test.go
//
...
func TestHeaderFlag(t *testing.T) {
	...
	tests := [...]tcase{
		...
		// No need to test the high bits 0x30-0xFF as they're reserved.
	}
