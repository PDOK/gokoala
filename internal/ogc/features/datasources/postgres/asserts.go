...
//
//nolint:nestif
func assertIndexesExist(configuredCollections config.CollectionsFeatures, tableByCollectionID map[string]*common.Table, db *pgxpool.Pool, spatialIndexRequired bool) error {
