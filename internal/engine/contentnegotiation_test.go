...
func TestContentNegotiation_NegotiateFormat(t *testing.T) {
	...
	testFormat(t, cn, "text/markdown", "http://pdok.example/ogc/api", "md")
	testFormat(t, cn, "application/json", "http://pdok.example/ogc/api?f=md", "md")
	testFormat(t, cn, "", "http://pdok.example/ogc/api?f=md", "md")
	testFormat(t, cn, "text/markdown, application/json;q=0.9", "http://pdok.example/ogc/api", "md")
