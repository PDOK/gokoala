...
func Test_generate(t *testing.T) {
	...
	tests := []struct {
		...
		{"avoid endless loop for synonyms that input value", args{map[string]string{"street": "oude kerkstraat"}, "../testdata/substitutions.csv", "../testdata/synonyms.csv"}, []map[string]string{{"street": "oude kerkstraat"}, {"street": "oud kerkstraat"}}, assert.NoError},
	}
